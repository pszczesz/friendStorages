...
namespace FriendStories.DAL {
    public class FileDataService:IDataServices {
        ...
        private void SaveToFile(List<Friend> friendsList) {
            string json = JsonConvert.SerializeObject(friendsList, Formatting.Indented);
        ...
        public IEnumerable<FriendGroup> GetAllFriendGroup() {
